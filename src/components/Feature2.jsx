...
const Feature2 = () => (
  <section
    id="clients"
    className="sm:py-5 py-5 px-2 flex justify-center items-center flex-col md:flex-col relative w-full bg-black shadow-lg rounded-lg"
  >
    {/* Background Gradient */}
    ...
    <div className="w-full flex flex-col justify-center items-center text-center sm:mb-6 mb-6 relative z-[1]">
      <h2 className="font-poppins font-semibold xs:text-[56px] text-[40px] text-white xs:leading-[76.8px] leading-[66.8px] w-full mb-4">
        So Biggg NAS (2TB Windows)
      </h2>
      <p className="font-poppins text-base text-gray-400 leading-relaxed max-w-[800px]">
        Empower your workflow with features that drive efficiency. Our platform
        ensures that you are equipped with the tools necessary to boost
